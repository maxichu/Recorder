...
public class VideoClip {
    ...
    public VideoClip(String filePath, String workingPath, String outName, double startTime, double endTime)
    {
    ...
    private void clip() {
        try {
            ...
            //计算剪切时间
            //Extra credits: Make the rendering seamless
            for (Track track : tracks) {
                if (track.getSyncSamples() != null
                    ...
                    startTime = VideoHelper.correctTimeToSyncSample(track, startTime, true);
